...
st.title("โครงการพยากรณ์ราคาน้ำมัน (แบบง่ายๆ)")
st.write("ทำโดยนิสิต : ตัวอย่างโปรเจควิชา Data Science")
...
if uploaded:
    ...
    # หาคอลัมน์ที่เป็นวันที่ (เดาเอาแบบง่ายๆ)
    date_col = None
    for c in df.columns:
        try:
            pd.to_datetime(df[c])
    ...
    # คอลัมน์ที่เหลือคือบริษัทน้ำมัน
